...
public class JdbcTemplate<T> {
    ...
    public <T> List<T> queryForObjects(String sql, PreparedStatementSetter pstmtSetter, RowMapper<T> rowMapper) throws SQLException {
    ...
    public void update(String sql, PreparedStatementSetter pstmtSetter, KeyHolder holder) {
        try (Connection conn = ConnectionManager.getConnection();
            ...
            if (rs.next()) {
                ...
                System.out.println("Generated Key: " + holder);
            }
            rs.close();
